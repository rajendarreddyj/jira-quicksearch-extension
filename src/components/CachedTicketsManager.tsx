  ...
  return (
    <div className="p-3 space-y-4">
      ...
      <div className="bg-slate-900 text-white rounded-xl p-3.5 space-y-3 shadow-md border border-slate-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs font-bold text-slate-100">Offline Ticket Cache Storage</h3>
              <p className="text-[11px] text-slate-400">Stores ticket details locally for instant offline access</p>
            </div>
          </div>
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-[11px] font-medium text-slate-300">
            ...
            <span className="text-emerald-400 font-mono text-[10px]">{formatKB(cacheStats.estimatedBytes)}</span>
          </div>
          <div className="w-full bg-slate-800 rounded-full h-2 overflow-hidden border border-slate-700/80">
            <div
      ...
      {cachedIssues.length > 0 && (
        <div className="bg-white rounded-xl p-3.5 space-y-3 border border-slate-200 shadow-2xs">
                ...
                return (
                  <div key={item.name} className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center gap-1.5 text-[11px]">
                      ...
                      <span className="text-slate-400 font-medium text-[10px]">({pct}%)</span>
                    </div>
                  </div>
                );
              })}
      ...
      {cachedIssues.length === 0 ? (
        <div className="p-8 text-center space-y-3 bg-white border border-slate-200 rounded-xl shadow-2xs">
          ...
          <div className="space-y-1">
            <p className="text-sm font-semibold text-slate-800">No Tickets Cached Offline</p>
